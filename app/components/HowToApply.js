...
//   return (
//     <section id="application-guide" className="py-20 bg-white">
...
//             <motion.div
//               key={index}
//               className="flex flex-col md:flex-row items-center gap-6 p-6 bg-lightGray shadow-lg rounded-xl"
...
//                   <div className="w-12 h-12 bg-darkGray text-gray-8 font-bold rounded-full flex items-center justify-center text-xl">
//                     {step.step}
//                   </div>
